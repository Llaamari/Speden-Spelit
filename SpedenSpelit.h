...
const int maxHighScores = 3;  // Tallennetaan 3 parasta scorea EEPROMiin

const int scoreButton =3; // Peli­näppäin 3 toimii scoreboard-näppäimenä pelin ulkopuolella
/*
...
/* 
will save 3 of the highest scores
updates scores when previous score is beating
can be opened and viewed before and after starting the game
*/

void readScoreBoard(int scores[]);

void writeScoreBoard(int scores[]);
